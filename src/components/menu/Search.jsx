const Search = () => {
  return (
    <div>
      <label
        className="text-gray-950 ml-auto relative bg-white min-w-sm max-w-xl flex flex-col md:flex-row items-center justify-center border-4 border-white py-1 px-2 rounded-2xl gap-2 shadow-2xl  focus-within:border-blue-300"
        htmlFor="search-bar"
      >
        <input
          id="search-bar"
